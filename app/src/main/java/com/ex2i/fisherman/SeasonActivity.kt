...
class SeasonActivity : AppCompatActivity() {
    ...
    private fun realmInsert() {
        ...
        insertModel(
            ...
            , "4~6월", "바다"
            , "한국, 일본, 중국, 오스트레일리아 북부",R.drawable.item_gapojinga,"갑오징어라고도 한다. 제주지역에선 맹마구리, 서산, 태안, 당진 부근에서는 찰배기나 찰박, 영덕에선 오작어, 강릉, 동해, 삼척 부근에서는 먹통, 여수, 장흥, 보성, 고흥 부근에선 배오징어나 깍세기라고도 부른다. 오징어뼈, 이걸치, 이고치뼈당구라 부르기도 한다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "북서태평양의 온대 해역",R.drawable.item_geenoraemi,"《자산어보(玆山魚譜)》에는 노래미로 기록되어 있다. 서해안에서는 노래미, 부산에서는 게르치, 동해안 강릉 지역에서는 돌삼치, 평안남도에서는 석반어로 불린다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "", "바다"
            , "태평양, 대서양, 인도양의 온대 및 아열대 해역",R.drawable.item_godoenga,"《자산어보》에 벽문어(碧紋魚)·고등어(皐登魚), 《재물보》에 고도어(古道魚), 《경상도 속한지리지》에 고도어(古都魚)라고 한 기록이 보인다. 일본명은 Hirasaba, Masaba이다. 오스트레일리아에서는 Common mackerel이라고 부른다. 몸은 길고 방추형으로 약간 측편(compressed:어류의 체형 가운데 좌·우로 납작한 형)되어 있다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "2~6월", "바다 속 모래 바닥"
            , "우리나라, 중국, 일본의 인근 해역",R.drawable.item_gwanga,"몸은 바다 밑 환경에 적응하여 납작하며, 몸색깔은 모래바닥과 잘 구분이 되지 않는 황갈색의 보호색을 띤다. 몸집이 큰 편이어서 1m 정도가 되는 것도 있으며 보통 암컷이 수컷에 비해 10cm 정도 더 크다. 몸의 가장자리에는 다소 단단한 지느러미가 있으며, 등쪽에는 77~81개, 배쪽에는 59~61개 정도의 뼈로 지느러미가 나와있다. 비늘이 매우 작은 편이며 가슴지느러미 부근에서 시작되는 옆줄은 107~120여 개의 비늘로 이루어져있다. 입이 크고 날카로운 이빨이 발달해 있으며, 아래턱이 위턱에 비해 앞으로 튀어나와 있다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "중국 남부, 일본, 한국 연근해",R.drawable.item_hakggongchi,"입이 학의 주둥이처럼 길게 튀어나와 있어서 학공치, 학꽁치라 불린다. 《자산어보》에는 공치로 기록되어 있다. 경북에서는 사이루, 경남에서는 꽁치, 강화도에서는 청갈치, 원산에서는 공매리, 강원도에서는 굉메리, 충남, 전남에서는 공치, 평안북도에서는 곰능이, 평안남도에서는 청망어라 불린다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "타이완, 동중국해, 일본 남부해, 한국 남부",R.drawable.item_hongampeng,"일본명은 Yumekasago이다. 최대 몸길이 30cm까지 성장한다. 몸은 소형으로 몸과 머리는 옆으로 납작하며 몸높이는 머리 뒷부분이 가장 높다. 눈은 크고 머리 앞부분 위쪽에 치우쳐 있다. 눈의 등쪽 가장자리를 따라 3∼4개의 가시가 나 있고 후두부에는 2개의 뒤로 향하는 가시가 있다. 눈 밑에는 어떠한 가시도 없다. 주둥이 끝은 날카롭고 입은 크며 경사져 있다. 위턱은 아래턱보다 약간 길고 눈의 중앙 아래에 달한다.\n" +
                    "\n" +
        ...
        insertModel(
            "호래기", "60mm", "", "연한 자주빛"
            , "3월", "연안"
            , "우리나라 전 연안, 동남아시아, 유럽",R.drawable.item_horagi,"화살오징어과에 속하는 연체동물이다. 정약전이 쓴 어류학서 자산어보(玆山魚譜) 에는 오징어와 비슷하나 몸이 좀더 길고 좁으며 등판에 껍질이 없고 종이장처럼 얇은 뼈를 가지고 있는 것으로, 선비들이 바다에서 나는 귀중한 고기라 하여 '고록어(高祿魚)'라고 불렸다고 써있다. 화살꼴두기과에는 꼴뚜기 외에 창꼴뚜기, 화살꼴뚜기, 흰꼴뚜기 등을 포함한 7종이 널리 알려져 있다.  \n" +
                    " \n" +
        ...
        insertModel(
            ...
            , "한국, 일본, 사할린섬, 중국 동북부, 연해지방, 시베리아",R.drawable.item_hwanga,"강원도에서는 황사리, 경북에서는 밀하라 불린다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "11∼1월", "근해의 암초"
            , "한국(남해), 일본(홋카이도)",R.drawable.item_hwangjumbolack,"몸체에 붙은 작은 점이 많아 ‘황점볼락’이라 부른다. 여수, 통영 지역에서는 ‘진강구’, ‘꺽더구’, ‘검서구’, ‘깍다구’라고 부르기도 한다. 볼락과 우럭을 합쳐 놓은 듯한 모습으로 볼락보다 머리가 크고 가시가 많다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "", "수심 50m 이내의 암초 지역"
            , "한국(남부·제주도), 일본, 타이완, 중국, 말레이시아, 인도",R.drawable.item_jabari,"몸길이 60cm 이상이다. 몸과 머리는 방추형이고 옆으로 납작하다. 등지느러미 연조(soft ray:마디가 있고 끝이 갈라져 있는 지느러미 줄기)의 기저(base:기관 또는 부속기관과 몸통과 연결되는 부위)에서 측선까지의 비늘은 13∼15개이다. 꼬리지느러미 끝은 둥글다. 몸빛깔은 다갈색 바탕에 옆구리에 6줄의 흑갈색 가로띠가 뒤쪽까지 있다. 각 띠는 모양이 일정하지 않다. 이 줄무늬는 자라면서 차차 희미해져 노성어가 되면 없어진다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "타이완, 동중국해, 일본 남부, 한국 등 북서태평양의 열대 해역",R.drawable.item_jeongangi,"경남에서는 ‘전광어’, 부산에서는 ‘메가리’또는 ‘전겡이’, 완도에서는 ‘가라지’, 함남에서는 ‘빈쟁이’, 제주에서는 ‘각재기’, 전남에서는 ‘매생이’라 부른다. 포항·마산등지에서는 일본명 그대로 ‘아지’라고 부르기도 한다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "타이완, 동중국해, 일본 남부, 한국 등 북서태평양의 열대 해역",R.drawable.item_jjuggumi,"전라남도와 충청남도에서는 쭈깨미, 경상남도에서는 쭈게미라고도 불린다. 흔히 '쭈꾸미'로 부르기도 하지만 '주꾸미'가 정확한 이름이다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "타이완, 동중국해, 일본 남부, 한국 등 북서태평양의 열대 해역",R.drawable.item_jopibolak,"몸길이 40cm 정도이다. 겉모습은 볼락과 비슷한데, 특히 누루시볼락과 가장 비슷하다. 눈의 앞쪽에는 날카로운 가시가 한 쌍 있고 눈 사이에는 두 쌍, 그 뒤로는 한 쌍의 가시가 튀어나와 있다. 눈 앞가장자리를 둘러싸고 있는 골격에는 아래로 향하는 3개의 가시가 있다. 입은 크며 위턱은 눈의 뒷가장자리에 달한다. 양 턱에는 매우 작은 이빨이 띠를 형성한다.\n" +
                    "\n" +
                    "전새개골(preopercle:아가미뚜껑부를 지지하는 4개의 뼈 중 하나)에는 5개, 주새개골(opercular:아가미뚜껑부를 지지하는 4개의 뼈 중 하나)에는 2개의 가시가 있다. 몸은 작고 미약한 사각형의 빗비늘로 덮여 있다. 양 턱과 아가미뚜껑에는 비늘이 없다. 측선의 비늘수가 38개 이상이다.  \n" +
                    "\n" +
                    "등지느러미는 1개로 극조(spinous ray:지느러미 중 연조가 경골화한 것으로 마디가 없음)부와 연조(soft ray:마디가 있고 끝이 갈라져 있는 지느러미 줄기)부는 깊게 파여 있다. 등지느러미 가시는 잘 발달되어 있으며 가시 사이의 막은 깊게 파여 있다. 등지느러미 연조부는 바깥쪽 가장자리가 둥글다. 가슴지느러미는 배쪽에 치우쳐 있으며 뒷가장자리가 둥글다. 배지느러미는 가슴지느러미보다 조금 뒤에서 시작하며 항문에 겨우 달한다. 뒷지느러미는 두 번째 가시가 비교적 강하며 가장자리는 둥글다.\n" +
        ...
        insertModel(
            ...
            , "", ""
            , "",R.drawable.item_kinggoribangedom,"국내에 서식하고 있는 벵에돔은 두 종류다. 제주도와 남해안 · 동해안에 모두 흔한 벵에돔, 그리고 제주도에 많은 긴꼬리벵에돔이다. 이 두 벵에돔은 생김새와 색상은 비슷하지만 습성은 전혀 딴판인 물고기다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "6∼7월", "수심 60m 부근"
            , "우리나라, 일본 남부해, 동중국해, 인도양, 호주 등지",R.drawable.item_kkochigogi,"속명인 스피라에나(Sphyraena)는 그리스어로 망치(hammer)를 의미하여 이는 지질학자들이 사용하는 뾰족한 망치와 비슷하게 생겼기 때문에 붙여진 이름이다. 봉암도에서는 꼬치라고 부른다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "우리나라, 중국, 일본 등의 북서태평양",R.drawable.item_mangsang,"《자산어보》에서는 망치어(望峙魚)로 소개하였다. 남해에서는 바다망성어, 충무에서는 망싱이, 흑산도에서는 망치어라고도 부른다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "", "수심 15~100m정도의 연안"
            , "남서태평양·남동중국해·한국(다도해 이남)·일본",R.drawable.item_muniojinga,"두족류에 속한다. 무늬오징어라고도 한다. 최대 몸길이 38cm, 최대 무게 5kg에 달하는 대형 오징어이다. 위쪽으로 보았을 때 전체적으로 타원형의 몸통을 갖는다. 배쪽에 입술자국의 무늬가 있으며, 등쪽 표면에도 입술자국 같은 무늬가 있어 산재하여 입술무늬오징어라는 이름이 붙었다. 몸통의 등쪽과 지느러미의 경계부분에 은백색의 세로줄이 나 있다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "우리나라의 남해, 일본, 인도네시아, 오스트레일리아 북서부를 지나는 서태평양",R.drawable.item_nonboldae,"몸에 비해 눈이 상당히 커서 사람들은 이 물고기에 ‘눈볼대’라는 이름을 붙였다. 또한 입 속이 검은 빛을 띠고 있기 때문에 ‘목이 검은 농어’라는 뜻의 ‘blackthroat seaperch’라는 영어 이름을 사용한다. 몸 빛이 붉어서 부산과 경상남도에서는 ‘빨간고기’ 또는 ‘붉은고기’로 부르기도 한다.\n" +
                    " \n" +
        ...
        insertModel(
            ...
            , "동중국해, 타이완, 일본, 한국 연근해",R.drawable.item_nonga,"《난호어목지》에는 '깍정'이라 하였고, 정약용의《아언각비》에서는 농어(農魚), 《자산어보》에서는 걸덕어(乞德魚)라 하였다. 경남 통영에서는 농에, 부산에서는 깡다구, 전남에서는 깔대기, 껄떡, 울릉도에서는 연어병치, 독도돔으로 불린다. 30cm 안팎의 작은 것은 부산에서는 까지매기, 완도에서는 절떡이라고 불리며, 특히 몸통에 검은 점이 많고 작은 것은 전남 순천과 장흥에서 깔따구, 껄떡이로 불린다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "", "연해와 내만"
            , "한국·일본·타이완·동중국해",R.drawable.item_nupchinoga,"몸길이 약 70cm이다. 몸은 가늘고 길며 옆으로 납작하다. 등지느러미의 가시부와 연조부는 분리되어 있고 성어의 연조수는 15∼16개이다. 아래턱 배쪽에 1줄의 비늘이 있고 유공측선(有孔側線)의 비늘이 71∼76개인 점이 특징이다.\n" +
        ...
        insertModel(
            ...
            , "", "연근해의 아표층"
            , "북서태평양의 온대 해역",R.drawable.item_samchi,"몸은 가늘고 길며 옆으로 납작하다. 등쪽은 회색을 띤 푸른색이며, 배쪽은 은백색으로 금속성 광택을 띤다. 몸 옆구리에는 회색의 반점이 7∼8줄 세로로 점이 흩어져 있고, 등, 가슴, 꼬리지느러미는 검은색이다. 매우 작은 비늘로 덮여 있다. 옆줄은 한 개로 물결무늬 모양이고, 옆줄의 아래 위에 직각방향으로 가느다란 가지가 많이 나와 있다. 최대 몸길이 100cm, 몸무게 7.1kg까지 성장한다.\n" +
                    "\n" +
                    "삼치 본문 이미지 1\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "중국, 타이완, 일본, 한국, 필리핀 등 서부태평양의 열대 해역",R.drawable.item_ssombangi,"일본명은 Utkari-kasago이다. 최대 몸길이 37cm까지 성장한다. 몸은 크고 몸높이는 높으며 옆으로 납작하다. 눈은 크며 두 눈 사이는 부드럽게 안으로 들어가 있다. 눈의 등쪽 가장자리를 따라 4개의 가시가 있고, 머리 뒷부분에는 3개의 가시가 있지만 눈의 아랫가장자리 골격에는 가시가 없다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "태평양, 대서양, 인도양의 온대·열대 해역",R.drawable.item_sunga,"《자산어보》에는 치어라 기재하고, 숭어의 형태·생태·어획·이명 등에 관하여 설명하고 있다. “몸은 둥글고 검으며 눈이 작고 노란빛을 띤다. 성질이 의심이 많아 화를 피할 때 민첩하다. 작은 것을 속칭 등기리(登其里)라 하고 어린 것을 모치(毛峙) 또는 모쟁이라고 한다. 맛이 좋아 물고기 중에서 제1이다.”라고 하였다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "1~2월", "암초로 된 연안"
            , "한국·일본 등 북서태평양의 아열대 해역",R.drawable.item_yeolgi,"《현산어보》에는 적박순어, 맹춘어로 기록되어 있다. 남해안에서는 열기, 함경북도에서는 동감펭이라고 불린다.\n" +
                    "\n" +
        ...
        insertModel(
            ...
            , "", "수심 100∼500m의 바다"
            , "서부태평양, 동중국해, 일본 남부, 한국 남해",R.drawable.item_yeonabyuongchi,"일본명은 Medai이다. 최대 몸길이 90cm까지 성장한다. 몸은 높고 횡단면은 타원형에 가까우며 옆으로 납작하다. 머리도 옆으로 납작하고 머리의 앞끝은 둥글다. 눈은 커서 지름이 주둥이의 길이보다 길다. 눈 앞쪽에는 2쌍의 콧구멍이 있고 앞콧구멍은 타원형이지만 뒤콧구멍은 칼로 찢은 듯하다.\n" +
                    "\n" +
